      ...
      <main className="min-h-screen bg-background">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Base Zero</h2>
        ...
        <header className="border-b border-border/40 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-2">
              <h1 className="text-4xl font-bold tracking-tight text-foreground">Base Zero</h1>
              <p className="text-muted-foreground text-sm">Premium self-custody crypto wallet</p>
            </div>
          </div>
        </header>
          ...
          {!walletDetected ? (
              ...
              <Card className="p-8 border-border/40 backdrop-blur-sm">
                <div className="space-y-6">
                  <div className="bg-amber-500/10 border border-amber-500/50 rounded-lg p-6">
                    <h3 className="font-semibold text-lg mb-3 text-amber-900 dark:text-amber-100">Important: USB Drive Required</h3>
                    <p className="text-sm text-amber-800 dark:text-amber-200 mb-3">
                      Base Zero requires an external USB drive to function. Your wallet will be stored as an encrypted .ert file on the drive.
                    </p>
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                      Please prepare a USB flash drive before creating your wallet.
                    </p>
                  </div>
            ...
            <Tabs defaultValue="dashboard" className="w-full">
              ...
              <TabsContent value="dashboard" className="transition-smooth">
                {address ? <Dashboard address={address} /> : <div>Loading...</div>}
              </TabsContent>
